...
interface InputCredentialsProps extends React.InputHTMLAttributes<HTMLInputElement> {
    errorMessage?: string
    valueInput: string
...
export function InputCredentials ({id, errorMessage, valueInput, handleInputRegister, IconSvg, handleViewPassword, ...rest}: InputCredentialsProps) {
