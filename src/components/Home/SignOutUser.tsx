...
export default function SignOutUser({username}: {username: string}) {
  ...
  return (
    <div className="absolute -top-1 left-0 -translate-y-full w-72 h-24 bg-black shadow-md shadow-white/20 rounded-3xl">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full rotate-180 border-r-8 border-r-transparent border-t-8 border-t-transparent border-l-8 border-l-transparent border-b-8 border-black drop-shadow-3xl"></div>
