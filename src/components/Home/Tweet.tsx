          ...
          <div className='flex gap-x-2'>
            ...
            <div className='w-full h-full'>
              ...
              <section className='w-full h-full'>
                <TweetContent idPost={tweet.id} username={creator.username} content={content} image_url={avatar} previewImage='main-tweets' />
                <TweetInteractions comments={comments} retuits={retuits} likes={likes} idTweet={id} interactionComment='comment-post'>
